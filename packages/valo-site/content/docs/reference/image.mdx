...
Upload needs a renderer, which the scene widget does not expose. Record
geometry on [Paint](/docs/reference/paint) or [Path](/docs/reference/path)
instead; those canvases share the same device.
