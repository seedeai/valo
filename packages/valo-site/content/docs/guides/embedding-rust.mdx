...
The crate's API is on [docs.rs](https://docs.rs/valo/latest/valo/). Valo uses
the wgpu device and queue owned by your application. For a first frame,
rendering to pixels avoids any window-system setup:
